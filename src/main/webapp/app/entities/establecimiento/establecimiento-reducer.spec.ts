...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTABLECIMIENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTABLECIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTABLECIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTABLECIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTABLECIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTABLECIMIENTO actions', async () => {
      const expectedActions = [
        {
