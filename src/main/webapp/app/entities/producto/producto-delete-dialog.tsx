...
export const ProductoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhispterBackendApp.producto.delete.question">
        <Translate contentKey="jhispterBackendApp.producto.delete.question" interpolate={{ id: productoEntity.id }}>
