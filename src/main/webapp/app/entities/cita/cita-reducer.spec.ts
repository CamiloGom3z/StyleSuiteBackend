...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cita.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CITA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITA actions', async () => {
      const expectedActions = [
        {
