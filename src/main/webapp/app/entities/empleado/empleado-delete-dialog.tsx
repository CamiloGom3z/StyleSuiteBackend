...
export const EmpleadoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhispterBackendApp.empleado.delete.question">
        <Translate contentKey="jhispterBackendApp.empleado.delete.question" interpolate={{ id: empleadoEntity.id }}>
