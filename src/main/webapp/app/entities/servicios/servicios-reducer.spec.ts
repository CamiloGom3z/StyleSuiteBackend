...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './servicios.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICIOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICIOS actions', async () => {
      const expectedActions = [
        {
