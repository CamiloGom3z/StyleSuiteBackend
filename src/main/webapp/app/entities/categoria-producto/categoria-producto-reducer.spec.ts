...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './categoria-producto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIAPRODUCTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORIAPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORIAPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORIAPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIAPRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORIAPRODUCTO actions', async () => {
      const expectedActions = [
        {
