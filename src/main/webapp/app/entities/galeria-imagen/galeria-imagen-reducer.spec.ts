...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GALERIAIMAGEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_GALERIAIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GALERIAIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GALERIAIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GALERIAIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GALERIAIMAGEN actions', async () => {
      const expectedActions = [
        {
