...
/**
 * REST controller for managing {@link com.backendstyle.myapp.domain.GaleriaImagen}.
 */
@RestController
@RequestMapping("/api")
public class GaleriaImagenResource {

    private final Logger log = LoggerFactory.getLogger(GaleriaImagenResource.class);
    ...
    public ResponseEntity<GaleriaImagenDTO> createGaleriaImagen(@RequestBody GaleriaImagenDTO galeriaImagenDTO) throws URISyntaxException {
        ...
        GaleriaImagenDTO result = galeriaImagenService.save(galeriaImagenDTO);
        return ResponseEntity
            .created(new URI("/api/galeria-imagens/" + result.getId()))
    ...
    public ResponseEntity<GaleriaImagenDTO> updateGaleriaImagen(
        ...
        GaleriaImagenDTO result = galeriaImagenService.update(galeriaImagenDTO);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/galeria-imagens/{id}", consumes = { "application/json", "application/merge-patch+json" })
     ...
     */
    @GetMapping("/galeria-imagens")
    public ResponseEntity<List<GaleriaImagenDTO>> getAllGaleriaImagens(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/galeria-imagens/{id}")
    public ResponseEntity<GaleriaImagenDTO> getGaleriaImagen(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/galeria-imagens/{id}")
    public ResponseEntity<Void> deleteGaleriaImagen(@PathVariable Long id) {
