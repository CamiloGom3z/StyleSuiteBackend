...
import com.backendstyle.myapp.domain.enumeration.MetodoPagoEnum;
import com.backendstyle.myapp.repository.PagoRepository;
import com.backendstyle.myapp.service.dto.PagoDTO;
import com.backendstyle.myapp.service.mapper.PagoMapper;
...
class PagoResourceIT {
    ...
    void createPago() throws Exception {
        ...
        assertThat(testPago.getCitaId()).isEqualTo(DEFAULT_CITA_ID);
        assertThat(testPago.getCarritoId()).isEqualTo(DEFAULT_CARRITO_ID);
    ...
    void putNewPago() throws Exception {
        ...
        assertThat(testPago.getCitaId()).isEqualTo(UPDATED_CITA_ID);
        assertThat(testPago.getCarritoId()).isEqualTo(UPDATED_CARRITO_ID);
    ...
    void partialUpdatePagoWithPatch() throws Exception {
        ...
        partialUpdatedPago.monto(UPDATED_MONTO).fechaPago(UPDATED_FECHA_PAGO).carritoId(UPDATED_CARRITO_ID).userId(UPDATED_USER_ID);
