...
class EstablecimientoResourceIT {
    ...
    void createEstablecimiento() throws Exception {
        ...
        assertThat(testEstablecimiento.getUrlImg()).isEqualTo(DEFAULT_URL_IMG);
        assertThat(testEstablecimiento.getUserId()).isEqualTo(DEFAULT_USER_ID);
    }
    ...
    void putNewEstablecimiento() throws Exception {
        ...
        assertThat(testEstablecimiento.getUrlImg()).isEqualTo(UPDATED_URL_IMG);
        assertThat(testEstablecimiento.getUserId()).isEqualTo(UPDATED_USER_ID);
    }
