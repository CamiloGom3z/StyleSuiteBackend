...
import com.backendstyle.myapp.domain.enumeration.EstadoEmpleadoEnum;
import com.backendstyle.myapp.repository.EmpleadoRepository;
import com.backendstyle.myapp.service.dto.EmpleadoDTO;
import com.backendstyle.myapp.service.mapper.EmpleadoMapper;
...
class EmpleadoResourceIT {
    ...
    private static final EstadoEmpleadoEnum DEFAULT_ESTADO = EstadoEmpleadoEnum.DISPONIBLE;
    private static final EstadoEmpleadoEnum UPDATED_ESTADO = EstadoEmpleadoEnum.OCUPADO;
    ...
    void createEmpleado() throws Exception {
        ...
        assertThat(testEmpleado.getUrlmg()).isEqualTo(DEFAULT_URLMG);
        assertThat(testEmpleado.getEstado()).isEqualTo(DEFAULT_ESTADO);
        assertThat(testEmpleado.getEstablecimientoId()).isEqualTo(DEFAULT_ESTABLECIMIENTO_ID);
    }
    ...
    void putNewEmpleado() throws Exception {
        ...
        assertThat(testEmpleado.getUrlmg()).isEqualTo(UPDATED_URLMG);
        assertThat(testEmpleado.getEstado()).isEqualTo(UPDATED_ESTADO);
        assertThat(testEmpleado.getEstablecimientoId()).isEqualTo(UPDATED_ESTABLECIMIENTO_ID);
    }
    ...
    void partialUpdateEmpleadoWithPatch() throws Exception {
        ...
        partialUpdatedEmpleado.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).salario(UPDATED_SALARIO);
